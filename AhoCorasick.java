...
//!! This program has error! only works for one pattern search at a time. If more than one patterns, no guarantee it will work.
public class AhoCorasick {
    ...
    public static void main(String[] args) {
        ...
        ahoCorasick.addString("bc");    //!! if more than one pattern, this code may not work
